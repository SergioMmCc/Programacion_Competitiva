...
const long long myNegativeInfinite = -2e12;

vector<long long> tree(MAXT*2 + 1);
int n;
...
void updateTree(int update, long long value) {
    tree[n + update] = value;
    update += n;
...
long long query(int l, int r) {
    long long ans = myNegativeInfinite;
    l += n; r += n; 
    while (l < r) {
